...
RSCore.Player.CheckPlayerData = function(source, PlayerData)
	...
	PlayerData.charinfo.account = PlayerData.charinfo.account ~= nil and PlayerData.charinfo.account or "NL0"..math.random(1,9).."EBANK"..math.random(1111,9999)..math.random(1111,9999)..math.random(11,99)
	...
	PlayerData.metadata["phonedata"] = PlayerData.metadata["phonedata"] ~= nil and PlayerData.metadata["phonedata"] or {
		SerialNumber = RSCore.Player.CreateSerialNumber(),
		InstalledApps = {},
	}
...
RSCore.Player.CreateSerialNumber = function()
	local UniqueFound = false
	local SerialNumber = nil
	
	while not UniqueFound do
		SerialNumber = math.random(11111111, 99999999)
		RSCore.Functions.ExecuteSql(true, "SELECT COUNT(*) as count FROM players WHERE metadata LIKE '%"..SerialNumber.."%'", function(result)
