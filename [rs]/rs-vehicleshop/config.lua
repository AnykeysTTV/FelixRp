...
RS.DefaultBuySpawn = {x = -56.79, y = -1109.85, z = 26.43, h = 71.5}

RSCustom.VehicleBuyLocation = {x = -772.82, y = -235.39, z = 37.07, h = 201.5, r = 1.0}
RSCustom.ShowroomPositions = {
    [1] = {
        coords = {
            x = -792.46, 
            y = -233.15, 
