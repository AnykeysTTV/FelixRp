...
$(document).on('click', '#whatsapp-openedchat-send', function(e){
    ...
    if (Message !== null && Message !== undefined && Message !== "") {
        ...
        QB.Phone.Notifications.Add("fab fa-whatsapp", "Whatsapp", "You cannot send a blank message!", "#25D366", 1750);
    }
});
...
//         if (OpenedChatPicture == null) {
//             $.post('http://qb-phone_new/GetProfilePicture', JSON.stringify({
