...
$(document).on('click', '.scan-search-vehicle', function(e){
    ...
    $.post('http://qb-phone_new/FetchVehicleScan', JSON.stringify({}), function(vehicle){
        if (vehicle != null) {
            ...
            QB.Phone.Notifications.Add("Police", "MEOS", "No vehicle around!");
...
AddPoliceAlert = function(data) {
    ...
    if (data.alert.coords != undefined && data.alert.coords != null) {
        AlertElement = '<div class="meos-alert" id="alert-'+randId+'"> <span class="meos-alert-new" style="margin-bottom: 1vh;">NEW</span> <p class="meos-alert-type">Notification: '+data.alert.title+'</p> <p class="meos-alert-description">'+data.alert.description+'</p> <hr> <div class="meos-location-button">LOCATIE</div> </div>';
    } else {
...
$(document).on('click', '.meos-recent-alert', function(e){
    ...
    if (alertData.coords != undefined && alertData.coords != null) {
        ...
        QB.Phone.Notifications.Add("police", "MEOS", "This message has no GPS Location!");
    }
});
