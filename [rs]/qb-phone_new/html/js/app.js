...
QB.Phone.Functions.closemaybe = function() {
        ...
        if (CanOpenApp) {
            if (QB.Phone.Data.currentApplication == null) {
                ...
                if (PressedApplication == "settings") {
                    ...
                    $.post('http://qb-phone_new/GetCurrentTaxi', JSON.stringify({}), function(data){
                        Setuptaxi(data);
                    });
                } else if (PressedApplication == "tows") {
                    $.post('http://qb-phone_new/GetCurrentTow', JSON.stringify({}), function(data){
                        Setuptows(data);
                    });
				
                } else if (PressedApplication == "mechs") {
                    $.post('http://qb-phone_new/GetCurrentMech', JSON.stringify({}), function(data){
                        Setupmechs(data);
                    });
				
				} else if (PressedApplication == "emergencys") {
                    $.post('http://qb-phone_new/GetCurrentEmergency', JSON.stringify({}), function(data){
        ...
        switch(event.data.action) {
            ...
            case "UpdateCallTime":
                ...
                if (!QB.Phone.Data.IsOpen) {
                    ...
                    $(".call-notifications-title").html("InCall ("+timeString+")");
                ...
                $(".phone-currentcall-title").html("InCall ("+timeString+")");
                break;
