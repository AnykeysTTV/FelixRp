                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "لقد بدأت الإتصال كمجهول");
                        }
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Phone", "انت بالفعل مشغول");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Phone", "الشخص يتحدث");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Phone", "هذا الشخص غير متوفر");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "لايمكنك الإتصال على نفسك");
        }
    });
});